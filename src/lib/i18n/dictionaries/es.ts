const es = {
  ...
  dashboard: {
    ...
    focusByClass: "Enfoque por Clase",
    focusByClassHint: "Minutos de pomodoro acumulados por clase.",
    focusEmpty:
      "Aún sin tiempo de enfoque registrado. Termina un pomodoro para empezar.",
    focusMost: "La más enfocada",
  },
  empty: {
  ...
  pomodoro: {
    ...
    audioNone: "Sin sonido",
    audioWhite: "Ruido blanco",
    audioRain: "Lluvia",
    audioEngine: "Motor",
    volume: "Volumen",
    byMinutes: "Por minutos",
    byRoute: "Por ruta",
    desiredMinutes: "Minutos deseados",
    routeSuggestions: "Rutas más cercanas a tu tiempo",
    noRoutes: "Sin rutas cercanas. Prueba otro tiempo.",
    origin: "Origen",
    destination: "Destino",
    selectAirport: "Elegir aeropuerto…",
    flightDuration: "Duración del vuelo",
    startFlight: "Despegar",
  },
  account: {
